...
var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,("Port by (EmirPlays) "), 24);
...
We use cookies for various purposes including analytics. By continuing to use Pastebin, you agree to our use of cookies as described in the Cookies Policy.  OK, I
